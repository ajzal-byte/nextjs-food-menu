...
//         {isExpanded ? children : `${(children as string).slice(0, 100)}...`}
//       </p>
//       <button onClick={handleToggle} className="text-[#4b6f65] hover:text-[#2e4a43]">
...
//       transition={
//         hoverEffect ? { duration: 0.3, ease: "easeInOut" } : undefined
//       }
//       style={style}
//     />
//   );
